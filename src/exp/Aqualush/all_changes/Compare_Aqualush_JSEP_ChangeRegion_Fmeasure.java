 ...
 */
public class Compare_Aqualush_JSEP_ChangeRegion_Fmeasure {

    public static void main(String[] args) {


        Result result_jsep = Aqualush_VSM_JSEP_All_Changes.getResult();
        Result result_changeRegion = Aqualush_VSM_ChangeRegion_All_Changes.getResult();
