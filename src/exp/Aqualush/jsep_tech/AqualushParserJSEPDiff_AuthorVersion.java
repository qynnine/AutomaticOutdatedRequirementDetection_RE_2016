...
import parser.JSEPDiffParser_AuthorVersion;

/**
 * Created by niejia on 15/12/3.
 */
public class AqualushParserJSEPDiff_AuthorVersion {
    public static void main(String[] args) {
        ...
        JSEPDiffParser_AuthorVersion parser4 = new JSEPDiffParser_AuthorVersion("data/Aqualush/JSEP_Diff/Aqualush_change4.txt", corpus4, corpus3,
        ...
        JSEPDiffParser_AuthorVersion parser5 = new JSEPDiffParser_AuthorVersion("data/Aqualush/JSEP_Diff/Aqualush_change5.txt", corpus5, corpus4,
        ...
        JSEPDiffParser_AuthorVersion parser7 = new JSEPDiffParser_AuthorVersion("data/Aqualush/JSEP_Diff/Aqualush_change7.txt", corpus7, corpus6,
