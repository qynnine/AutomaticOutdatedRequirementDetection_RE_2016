 ...
 */
public class JSEPDiffParser_MyVersion {
    ...
    public JSEPDiffParser_MyVersion(String diffFilePath, CorpusExtractor newCorpus, CorpusExtractor oldCorpus, String outDirPath, String projectName, String versionName) {
    ...
    private void addClassToCroup(ClassGroupArtifact ca, String className, CorpusExtractor corpus, String changeType) {
        if (className.equals("edu.ncsu.csc.itrust.dao.mysql.ReasonCodesDAO")) {
            System.out.println("haha");
        }

        ca.setEntireNewArtifact();
