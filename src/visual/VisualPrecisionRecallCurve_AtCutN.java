 ...
 */
public class VisualPrecisionRecallCurve_AtCutN extends JFrame {
    ...
    public VisualPrecisionRecallCurve_AtCutN() {
    }

    public VisualPrecisionRecallCurve_AtCutN(PrecisionRecallCurve precisionRecallCurve) {
